...
router.post('/classes/:id/lessons/new', checkInstructor, (req, res, next) => {
  ...
  info.lessson.lessson_result_script1 = req.body.lessson_result_script1;
  info.lessson.lessson_result_script2 = req.body.lessson_result_script2;
  info.lessson.lessson_result_script3 = req.body.lessson_result_script3;
